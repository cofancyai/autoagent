...
class Settings(BaseSettings):
    ...
    llm_enable_prompt_caching: bool = Field(default=True, alias="LLM_ENABLE_PROMPT_CACHING")

    # Rate Limiting
    rate_limit_requests_per_minute: int = Field(default=50, alias="RATE_LIMIT_REQUESTS_PER_MINUTE")
    rate_limit_tokens_per_minute: int = Field(default=40000, alias="RATE_LIMIT_TOKENS_PER_MINUTE")
